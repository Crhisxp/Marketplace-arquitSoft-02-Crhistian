...
| :--- | :--- | :--- |
| **Presentación** | ¿Cómo interactúa el usuario? | Permite la interacción mediante Aplicación Web y API REST. |
| **Lógica de negocio** | ¿Qué hace el sistema? | Lógica de Usuarios, Sellers, Catálogo, Carrito y Pedidos. |
| **Datos** | ¿Dónde se almacena la información? | Almacenamiento y consulta persistente en Base de Datos. |
